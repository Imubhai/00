...
# Configuration
TELEGRAM_BOT_TOKEN = ("7690452228:AAF9idqw-TrTLHIVIZOz_hoI_6xYCDvxQnk")  # Fetch token from environment variable
ADMIN_USER_ID = 5559866295
...
async def alluser(update: Update, context: CallbackContext):
    ...
    if not await is_admin(chat_id):
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ 𝐎𝐍𝐋𝐘 IMU 𝐂𝐀𝐍 𝐔𝐒𝐄 𝐓𝐇𝐈𝐒 𝐂𝐎𝐌𝐌𝐀𝐍𝐃.*", parse_mode='Markdown')
        return
...
async def attack(update: Update, context: CallbackContext):
    ...
    if str(chat_id) not in approved_ids and str(user_id) not in approved_ids:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ 𝐈𝐒 𝐁𝐎𝐓 𝐊𝐀 𝐔𝐏𝐀𝐘𝐎𝐆 𝐊𝐀𝐑𝐀𝐍𝐄 𝐊𝐄 𝐋𝐈𝐘𝐄 𝐀𝐀𝐏𝐀𝐊𝐎 𝐎𝐖𝐍𝐄𝐑 𝐊𝐈 𝐀𝐍𝐔𝐌𝐀𝐓𝐈 𝐊𝐈 𝐀𝐀𝐕𝐀𝐒𝐇𝐘𝐀𝐊𝐀𝐓𝐀 𝐇𝐀𝐈 @IMUBHAIH.*", parse_mode='Markdown')
        return
...
async def run_attack(chat_id, ip, port, time, context):
    ...
    try:
        ...
        "*𝐒𝐄𝐍𝐃 𝐅𝐄𝐄𝐃𝐁𝐀𝐂𝐊 𝐓𝐎 𝐎𝐖𝐍𝐄𝐑 :-@IMUBHAIH*" , parse_mode='Markdown')
